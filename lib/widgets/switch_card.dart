                    ...
                    children: [
                      IconButton(
                          ...
                          onPressed: () {
                            ...
                            //   showToast(context,
                            //       "You should be connected to ${widget.switchesDetails.switchSSID} to delete the switch settings");
                            //   return;
                            // }
                            showDialog(
                                context: context,
                                builder: (cont) {
                                  ...
                                  return Form(
                                    key: formKey,
                                    child: AlertDialog(
                                      title: Text(widget.switchesDetails.switchSSID),
                                      content: const Text(
                                                ...
                                                OutlinedButton(
                                                  onPressed: () {
                                                    if (formKey.currentState!
                                                        .validate()) {
                                                      if (_pinController.text == widget.switchesDetails.privatePin) {
                                          ...
                                          pinDialog.showPinDialog(
                                            ...
                                            onSuccess: () {
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) => ShareQRPage(switchDetails: widget.switchesDetails)
                                                ),
                                              );
                                            },
                                          );
