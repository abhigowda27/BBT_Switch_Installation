                    ...
                    children: [
                      ...
                      IconButton(
                          ...
                          onPressed: () {
                            ...
                            if (localConnectStatus != widget.routerDetails.name) {
                              showToast(context,
                            ...
                            showDialog(
                                ...
                                builder: (cont) {
                                  ...
                                  return Form(
                                    key: formKey,
                                    child: AlertDialog(
                                      title: Text(widget.routerDetails.switchName),
                                      content: const Text(
                                            ...
                                            TextFormField(
                                              ...
                                              validator: (value) {
                                                ...
                                                if (_pinController.text !=
                                                    widget.routerDetails.privatePin) {
                                                ...
                                                OutlinedButton(
                                                  onPressed: () {
                                                    if (formKey.currentState!
                                                        .validate()) {
                                                      if (_pinController.text == widget.routerDetails.privatePin) {
                                                        _storageController.deleteOneRouter(widget.routerDetails);
                                          ...
                                          pinDialog.showPinDialog(
                                            ...
                                            onSuccess: () {
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) => ShareQRPage(routerDetails: widget.routerDetails)
                                                ),
                                              );
                                            },
                                          );
