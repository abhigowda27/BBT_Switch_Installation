...
class GroupSwitchOnOff extends StatefulWidget {
  ...
  final String selectedRouter; // Make this nullable
                        ...
                        return Switch(
                          onChanged: (value) async {
                            ...
                            if (!isConnected) {
                              showToast(
                                context,
                                "You should be connected to refresh the switch settings",
                              );
                              setState(() {
                                isSwitchOn = !value;
                              });
                            ...
                            for (var switchDetails in routers) {
                              ...
                              //await _storageController.saveSwitchState(switchDetails.name, value);
                            }
